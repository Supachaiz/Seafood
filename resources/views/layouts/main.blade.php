            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                            <li class="nav-item">
                                <a class="nav-link fs-15 fw-semibold active" href="#hero">หน้าหลัก</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-15 fw-semibold" href="#services">เกี่ยวกับร้าน</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-15 fw-semibold" href="#features">สินค้า</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-15 fw-semibold" href="#plans">บริการ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-15 fw-semibold" href="#reviews">ติดต่อเรา</a>
                            </li>
                        </ul>
